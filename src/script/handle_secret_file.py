...
from lib.secret.secret import SecretFileGenerator, SecretFileConverter, ENV_PROD, ENV_DEV, ENV_DEV_LOCAL  # flake8: noqa: E402
...
elif args.action == 'generate_local_development':
    secrets_generator = SecretFileGenerator()
    secrets_generator.generate(ENV_DEV_LOCAL)

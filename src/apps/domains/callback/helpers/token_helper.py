...
class TokenHelper:
    ...
    @classmethod
    def get_tokens(cls, client: Application, code: str, redirect_uri: str = None) -> Tuple[TokenData, TokenData]:
        return cls._take_token(client, code, redirect_uri)

    @staticmethod
    def _get_request_data(client: Application, code: str, redirect_uri: str):
...
class TokenCodeHelper(TokenHelper):
    @classmethod
    def _get_request_data(cls, client: Application, code: str, redirect_uri: str) -> dict:
...
class TokenRefreshHelper(TokenHelper):
    @classmethod
    def _get_request_data(cls, client: Application, refresh_token: str, redirect_uri: str) -> dict:
        data = cls._get_default_request_data(client)

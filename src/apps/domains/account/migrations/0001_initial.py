# Generated by Django 2.0.2 on 2018-02-09 19:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idx', models.AutoField(primary_key=True, serialize=False, verbose_name='u_idx')),
                ('id', models.CharField(max_length=16, unique=True, verbose_name='u_id')),
            ],
            options={
                'verbose_name': '사용자 계정',
